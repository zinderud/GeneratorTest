...
export { AddressesDelete } from './address/entityDelete';

export { ProgramUsersUi } from './programUser/entityUi';
export { ProgramUsersCreate } from './programUser/entityCreate';
export { ProgramUsersEdit } from './programUser/entityEdit';
export { ProgramUsersDelete } from './programUser/entityDelete';

export { DoctorsUi } from './doctor/entityUi';
